...
public class AdapterVideoList extends RecyclerView.Adapter<AdapterVideoList.MyViewHolder> {
    ...
    AdapterVideoList(Context context, ArrayList<ModelVideo> videosList, Coach coach){
        this.context = context;
        this.videosList = videosList;
        this.mCoach = coach;
    }
    ...
    public void onBindViewHolder(@NonNull AdapterVideoList.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), CoachVideo.class);
                intent.putExtra("Coach", mCoach);
