...
public class CoachProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.todoboom);
    ...
    private void initializeViews() {
      ...
      //  recyclerView.setLayoutManager(new GridLayoutManager(this, 3)); //3 = column count
        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)); //3 = column count
        adapterVideoList = new AdapterVideoList(this, videosList, mCoach);
